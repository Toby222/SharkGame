SharkGame.Upgrades = {
	...
	getUpgradeTable(worldType = world.worldType) {
		...
		if (!_.has(SharkGame.Upgrades.generated, worldType)) {
			SharkGame.Upgrades.generated[worldType] =
				SharkGame.Upgrades.generateUpgradeTable(worldType);
		}
	...
	getUpgradeData(table, upgradeName) {
		...
		if (data.cost?.science && data.cost.science <= theThing) {
	...
	generateUpgradeTable(worldType = world.worldType) {
		/** @type {UpgradeTable} */
		let finalTable = {};
		const defaultUpgrades = SharkGame.MiscUtil.cloneDeep(
			SharkGame.Upgrades.default,
		);
		if (_.has(SharkGame.Upgrades, worldType)) {
			const worldUpgrades = SharkGame.MiscUtil.cloneDeep(
				SharkGame.Upgrades[worldType],
			);
	...
	default: {
		crystalBite: {
			...
			researchedMessage:
				"Weird teeth-wear has been developed, and sharks can now catch fish better as a result.",
			effectDesc:
		...
		crystalSpade: {
			...
			researchedMessage:
				"The rays can now bother the sand more effectively, and dig up more sand now!",
			effectDesc:
				"Rays are twice as effective with their specially adapted digging tools.",
			cost: {
				science: 50,
				sand: 500,
				crystal: 5,
		...
		crystalScoop: {
			...
			researchedMessage:
				"Our crabs used to brush aside the sand to look for crystals - now they can scoop it! Scoopy scoop.",
			effectDesc:
		...
		crystalContainer: {
			...
			effectDesc:
				"Scientists are twice as effective at making with the science.",
			cost: {
				science: 100,
				crystal: 50,
			},
		...
		underwaterChemistry: {
			...
			effectDesc:
				"Scientists are twice as effective with their new chemical insights.",
			cost: {
				science: 200,
				crystal: 50,
			},
		...
		thermalVents: {
			...
			researchedMessage:
				"This is a wondrous, unending source of heat! Something good must come from this.",
		...
		laserRays: {
			...
			researchedMessage:
				"The rays can now be granted gear that will let them fuse sand into crystal! Future!",
			effectDesc:
				"Laser rays can now be geared up to burn the very sand to glassy crystal.",
			cost: {
				science: 100,
				sand: 5000,
				crystal: 100,
		...
		automation: {
			...
			researchedMessage:
				"Now we don't have to do all the work, machines can do it for us! Future!!",
			effectDesc:
				"Machines can be built to supplement population duties. This is efficient.",
			cost: {
				science: 3500,
				sharkonium: 250,
			},
		...
		engineering: {
			...
			researchedMessage:
				"The machines are twice as good now! We've figured out new designs in the process, too!",
			effectDesc:
		...
		agriculture: {
			...
			effectDesc:
				"Advances in agriculture will fuel future endeavors. Who knows what we'll do next!",
			cost: {
				science: 500,
				sand: 1500,
			},
		...
		exploration: {
			...
			effectDesc:
				"Sharks and rays are twice as effective. Did you know oceans are big? Fascinating!",
			cost: {
				science: 10000,
				fish: 50000,
			},
		...
		farExploration: {
			...
			researchedMessage:
				"Crystal-rich deposits were found, as well as strange, deep chasms.",
			effectDesc:
	...
	abandoned: {
		...
		environmentalism: {
			...
			researchedMessage:
				"With the right kind of stretching and squishing, we can turn sponges into weird little filter things!",
			effectDesc:
				"Sponges can be turned into filters to stop the tar from killing us all. Yay!",
			cost: {
				science: 250,
				sponge: 15,
			},
		...
		octopusMethodology: {
			...
			effectDesc:
				"Octopuses can specialise in investigation, and octopuses work twice as efficiently.",
			cost: {
				science: 888,
				clam: 888,
			},
		...
		octalEfficiency: {
			...
			effectDesc:
				"Octopuses, investigators, and their machines are twice as effective. Find unity in efficiency.",
			cost: {
				science: 8888,
				clam: 88888,
			},
		...
		exploration: {
			...
			researchedMessage:
				"Fish, sand, and crystals can be found! Even further out, though, there's something else.",
			effectDesc:
				"Crabs are 4 times more effective, and collectors are twice as effective...and something was spotted in the distance.",
			cost: {
				science: 30000,
				fish: 30000,
			},
		...
		reverseEngineering: {
			...
			effectDesc:
				"Ancient parts can be sacrificed for science. Scientists are twice as effective, and investigators are 4 times as effective.",
			cost: {
				science: 150000,
				ancientPart: 350,
			},
		...
		highEnergyFusion: {
			...
			researchedMessage:
				"The secret of high-energy fusion has been unlocked. Scavenge no more. We will do it ourselves.",
			effectDesc:
		...
		investigatetions: {
			...
			researchedMessage:
				"Using our reverse-engineering techniques, the investigators have come up with a theory on how to open the gate!",
			effectDesc:
				"Gate investigated. We think we have a way to open it, but it's not gonna be easy...the mechanism is complicated.",
			cost: {
				science: 4e7,
				investigator: 500,
			},
		...
		artifactAssembly: {
			...
			researchedMessage:
				"It worked perfectly! Our little controller managed to coax the gate into turning on!",
		...
		eightfoldOptimisation: {
			...
			researchedMessage:
				"Peak productivity attained. Maintain course. Maintain efficiency.",
			effectDesc:
				"Octopuses and their roles, as well as their machines, are all eight times as effective. Optimised.",
			cost: {
				science: 8e7,
			},
			required: {
		...
		mechanisedAlchemy: {
			...
			researchedMessage:
				"We are blurring the line between science and magic more than ever before!",
			effectDesc:
	...
	haven: {
		...
		agriculture: {
			effectDesc:
				"Dolphin effectiveness times 2. Discovered agricultural methods. We'll see if this bears fruit.",
			cost: {
				science: 500,
				sand: 10000,
				coral: 100,
		...
		coralCollection: {
			...
			researchedMessage:
				"So it's a cultural thing. Fine, collect your coral. See if I care.",
		...
		delphineHistory: {
			...
			researchedMessage:
				"A dolphin overheard us talking about it, and they came over and 'read' something from it. What?!",
			effectDesc:
		...
		dolphinTechnology: {
			...
			effectDesc:
				"We've figured out some dolphin machinery. As expected, it's not the best - but it'll have to do.",
			cost: {
				science: 50000,
				delphinium: 15000,
			},
		...
		farExploration: {
			...
			researchedMessage:
				"Crystal-rich deposits were found, as well as what appears to be the portal of dolphin legend.",
			effectDesc:
				"Crabs are 4 times as effective, planters 8 times. Did you know oceans are actually even bigger than big? Remarkable!",
			cost: {
				science: 375000,
				fish: 10000000,
			},
		...
		whaleSong: {
			...
			researchedMessage:
				"What we've put together is definitely a song...but something's missing. This can't be the whole thing.",
			effectDesc:
		...
		retroactiveRecordkeeping: {
			...
			researchedMessage:
				"The dolphins were the first to volunteer with helping to organize this stuff. I GUESS we could give them a chance.",
			effectDesc:
	...
	frigid: {
		...
		seabedGeology: {
			researchedMessage:
				"Not only did we find a whole bunch of weird things, we found that there was more sand!",
			effectDesc:
		...
		civilContact: {
			...
			researchedMessage:
				"We visited the structures, and it turns out it's an entire civilization!",
			effectDesc:
		...
		teamSpirit: {
			...
			effectDesc:
				"Sharks, crabs, urchins, extraction teams, scientists, and squid production times 2. Go team?",
			cost: {
				science: 3000,
			},
			required: {
		...
		agriculture: {
			...
			effectDesc:
				"Urchins gather kelp twice as fast. Just kelp. Only the kelp.",
			cost: {
				science: 350,
				sand: 400,
			},
		...
		assistedExtraction: {
			...
			effectDesc:
				"We may now organize crabs and squid into teams of 2 to expedite crystal extraction.",
			cost: {
				science: 650,
				kelp: 250,
			},
		...
		squidBiology: {
			...
			researchedMessage: "",
			effectDesc:
				"Squid are twice as effective. Squid can now be assigned to breed in a collective.",
			cost: {
				science: 1500,
			},
			required: {
		...
		urchinBiology: {
			...
			effectDesc:
				"Urchins are twice as effective. Urchins can now be assigned to go make more urchins.",
			cost: {
				science: 1750,
				kelp: 750,
			},
		...
		exploration: {
			...
			desc: "Swim beyond the home seas to see what can be found!",
			researchedMessage:
				"Found lots of fish, but also a giant wall of cracked ice. It's like a bubble around us as far as we can see!",
			effectDesc:
				"Sharks are twice as effective, squids are twice as effective. Did you know oceans are big? Fascinating!",
			cost: {
				science: 6500,
				fish: 25000,
			},
		...
		glacialNavigation: {
			...
			effectDesc:
				"Extraction teams are four times as effective thanks to newly-discovered crystal deposits.",
			cost: {
				science: 8000,
				fish: 90000,
			},
		...
		internalInvestigation: {
			...
			effectDesc:
				"We accidentally discovered the underground complex. The squid do not seem to know we have stumbled upon it.",
			cost: {
				science: 35000,
			},
			required: {
		...
		artificialHeating: {
			...
			researchedMessage:
				"With machines, of course! And copious amounts of kelp for power. Don't ask.",
		...
		engineering: {
			...
			researchedMessage:
				"The machines are twice as good now! We've figured out new designs in the process, too!",
			effectDesc:
				"Machines are twice as effective. Auto-transmuters are now possible to create.",
			cost: {
				science: 55000,
				sharkonium: 10000,
			},
		...
		iterativeDesign: {
			...
			researchedMessage:
				"As it turns out, science is about learning from mistakes, or so the scientists say. About their own mistakes.",
			effectDesc:
				"Scientists are 4 times as effective, and all shark machines run twice as fast. Again!",
			cost: {
				science: 350000,
				sharkonium: 75000,
			},
		...
		creatureCoalition: {
			...
			effectDesc:
				"Sharks and crabs x8. Urchins, squids, extraction teams and scientists x4. Go team!",
			cost: {
				science: 1250000,
			},
			required: {
		...
		internalExpedition: {
			...
			researchedMessage:
				"The expedition went well, but on the way out, a squid noticed us leaving the machine. I guess the jig is up.",
			effectDesc:
		...
		rapidRecharging: {
			...
			effectDesc:
				"Battery has been replaced. All the nearby ice has melted and we can now begin using the gate.",
			cost: {
				science: 3250000,
				sharkonium: 250000,
			},
	...
	shrouded: {
		...
		seabedGeology: {
			...
			effectDesc:
				"Rays gather sand twice as fast now that we...know where the sand is, and eels can be recruited into the frenzy.",
			cost: {
				science: 400,
				sand: 750,
			},
		...
		jellyfishHunting: {
			...
			effectDesc:
				"Jellyfish can be caught like fish. Hey, a fish is a fish, right?",
			cost: {
				science: 750,
			},
			required: {
		...
		jellyDiving: {
			...
			researchedMessage:
				"Huzzah, the divers now collect jellyfish! They're- ooh. Oh, boy. That must have hurt.",
			effectDesc:
				"Shark divers now sometimes collect jellyfish. Here's hoping it's worth the trouble.",
			cost: {
				science: 1000,
				jellyfish: 20,
			},
		...
		eelHabitats: {
			...
			effectDesc:
				"Eels are twice as effective now we know how they prefer to live. Also, they can now breed in pits, or something.",
			cost: {
				science: 2250,
			},
			required: {
		...
		exploration: {
			...
			desc: "Swim beyond the home seas to see what can be found!",
			researchedMessage:
				"Found lots of schools of fish, and so much sand! We also stumbled upon some gigantic chasms in the seafloor!",
			effectDesc:
				"Sharks and rays and divers are twice as effective. Did you know oceans are big? Fascinating!",
			cost: {
				science: 22500,
				fish: 15000,
			},
		...
		chimaeraReunification: {
			...
			researchedMessage:
				"Yeah, they're sharks alright. Sort of. Like, they're close enough! Most say they're glad to see us.",
			effectDesc:
				"Chimaeras can be recruited. We sharks should stick together!",
			cost: {
				science: 45000,
				jellyfish: 2500,
			},
		...
		shroudedChasmExploration: {
			...
			effectDesc:
				"Chimaeras find jellyfish twice as fast. We found some weird artifact thingies, but we don't know what's up with them.",
			cost: {
				science: 125000,
				fish: 1500000,
			},
		...
		arcaneSifting: {
			...
			researchedMessage:
				"Eels tasked with sifting through the sand have come back with even more arcana. We should keep this up!",
		...
		arcaneStudy: {
			...
			researchedMessage:
				"The scientists have helped to teach the rays in the ways of their study. Our understanding grows ever stronger.",
			effectDesc:
		...
		bioelectricity: {
			...
			researchedMessage:
				"The eels have developed a tool to pump bioelectricity directly into machines! Brilliant!",
			effectDesc:
				"Machines are four times as effective. Eel-harnessed energy is weird, but practical.",
			cost: {
				sharkonium: 200000,
				arcana: 2000,
			},
		...
		arcaneSacrifice: {
			...
			effectDesc:
				"Arcana can now be shattered, sacrificing them for the greater good.",
			cost: {
				arcana: 10000,
			},
			required: {
	...
	marine: {
		...
		crustaceanBiology: {
			...
			researchedMessage:
				"We've figured out how these shellfish function. There's far too many limbs involved.",
			effectDesc:
		...
		calciniumStudies: {
			...
			researchedMessage:
				"And there we have it. Calcinium, I guess! Surprisingly strong.",
			effectDesc:
		...
		calciniumRobotics: {
			...
			researchedMessage:
				"With enough effort, we've managed to fashion calcinium tools for the frenzy.",
			effectDesc:
		...
		bioengineering: {
			...
			researchedMessage:
				"We planted chips in everyone we could find. Efficiency has increased enormously!",
			effectDesc:
				"128x efficiency to sharks and planters, 64x to scientists, crabs, and lobsters, 32x to rays. It's about time!",
			cost: {
				science: 250000000,
				calcinium: 7500000,
			},
		...
		highEnergyFusion: {
			...
			researchedMessage:
				"The process is so bright, it could melt out our eyes - but it's so much better than the old fusion.",
			effectDesc:
		...
		sentientCircuitBoards: {
			...
			researchedMessage:
				"Despite objections, the plan went ahead. Birthgivers now transfer their cybernetics to every single child they bear.",
			effectDesc:
		...
		mobiusShells: {
			...
			effectDesc:
				"We tried to ask them what happened. They won't talk to us anymore.",
			cost: {
				calcinium: 5e10,
				lobster: 1e8,
			},
	...
	volcanic: {
		packHunting: {
			...
			researchedMessage:
				"By hunting in groups, rays can now effectively target large schools of fish before they dart away.",
			effectDesc:
				"Hunting in groups makes rays twice as effective. Shark strategy is efficient.",
			cost: {
				science: 25,
				fish: 1000,
			},
		...
		thermalVents: {
			...
			desc: "Investigate the boiling vents that just seem to keep on heating things up.",
			researchedMessage:
				"As it turns out, they're constantly spewing out resources! So that's where all this sand is coming from...",
			effectDesc:
				"A power source for future technologies has been discovered, but more importantly, we can begin taking stuff from the vents.",
			cost: {
				science: 1500,
				sand: 5000,
				coral: 100,
		...
		consistentCommunication: {
			...
			researchedMessage:
				"With ample demonstration of what we've gathered through farming, a few shrimp are convinced of our good intentions.",
			effectDesc:
				"Can now hire shrimp, though they're kinda mean. How were we supposed to know that sponge needs algae for some reason?",
			cost: {
				sponge: 250,
			},
			required: {
		...
		biology: {
			...
			researchedMessage:
				"With a better grasp of our own biology, we can better understand our limitations. Maybe we should keep this up.",
			effectDesc:
		...
		sociology: {
			...
			researchedMessage:
				"Progress, prosperity, organization, order. We choose to be a part of this society, and that is what creates it.",
			effectDesc:
				"Shrimp and sponge farms are twice as effective now that we can grasp the idea of a social system being different than ours.",
			cost: {
				science: 15000,
				sponge: 1000,
			},
		...
		eusociality: {
			...
			effectDesc:
				"Shrimp queens are available, sponge farms are twice as fast, and we'll never sleep soundly again.",
			cost: {
				sponge: 7500,
			},
			required: {
		...
		xenobiology: {
			...
			researchedMessage:
				"Yes, they are alive! They live, but not like us. They sit still for some reason!",
			effectDesc:
				"Unlocked the secrets of sponge. Sorta. Sponge farms produce twice as many now.",
			cost: {
				science: 100000,
			},
			required: {
		...
		properPractices: {
			...
			researchedMessage:
				"By arranging sponges in rows, we can give them all the space they need to grow! Eureka!",
		...
		wormWarriors: {
			...
			researchedMessage:
				"Our efforts have lead to the establishment of a new shrimp caste - the worm warrior.",
			effectDesc:
				"Shrimp queens are twice as efficient now that they don't need to worry about worms eating them.",
			cost: {
				sponge: 75000,
				shrimp: 5000,
			},
		...
		coralCloning: {
			...
			researchedMessage:
				"Wow! This is alive too! The world is so incredible. Let's farm them.",
			effectDesc:
				"Unlocked coral farms. I wonder what else is alive! Are the vents alive? What about these rocks?",
			cost: {
				science: 250000,
				coral: 2500,
			},
		...
		broodingBiology: {
			...
			researchedMessage:
				"With enough careful study, we were able to discern that less than 20 crabs are actually needed to make more.",
		...
		secretSmelting: {
			...
			effectDesc:
				"Learned the secret of porite from the shrimp. Glass has never been so useful, probably.",
			cost: {
				sponge: 40000000,
				sand: 8000000,
			},
		...
		secretSmithing: {
			...
			researchedMessage:
				"After consulting our shrimp informants about it, they have suggested that we use the glass to forge tools.",
			effectDesc:
				"Farmer shrimp, researcher crabs, and shoveler rays are now available. ",
			cost: {
				science: 6500000,
				porite: 1500000,
			},
		...
		medicallyAssistedReproduction: {
			...
			effectDesc:
				"All breeders are 4 times more effective because a lot more children are making it through to adulthood.",
			cost: {
				science: 1.75e8,
			},
			required: {
		...
		superSmelting: {
			...
			researchedMessage:
				"Using the giant geothermal vents as supersized forges, we can mass-produce porite!",
			effectDesc:
		...
		firstDraft: {
			...
			researchedMessage:
				'We sent a letter with a ray. The ray came back in a panic, holding another note. The king is not impressed by our "vapid flattery."',
			effectDesc:
		...
		superShovels: {
			...
			researchedMessage:
				"With enough thinking, we agreed on an amazing solution: we simply make the shovels bigger.",
			effectDesc:
				"Rays and their professions are four times as effective and impactful thanks to huge tools. These things are big, so it's good that the sea has basically infinite sand.",
			cost: {
				science: 1.75e10,
				porite: 2.5e9,
			},
		...
		massProduction: {
			...
			effectDesc:
				"Our ability to mass-produce tools makes farmers, shovelers, and researchers cost a fifth as much porite.",
			cost: {
				porite: 2e11,
			},
			required: {
		...
		secondDraft: {
			...
			researchedMessage:
				"We tried again, this time sending a group of shrimp. Only one returned.",
			effectDesc:
		...
		algaeAcolytes: {
			...
			effectDesc:
				"There is now a cult. Of algae. Algae worship and total dedication. I'm not sure if this is a good thing.",
			cost: {
				algae: 2e9,
				sponge: 5e12,
			},
		...
		centralCollection: {
			...
			effectDesc:
				"A more organized system of sponge collection has quadrupled sponge profits.",
			cost: {
				sponge: 5e15,
			},
			required: {
		...
		rumoredRecollections: {
			...
			researchedMessage:
				"Rumors say the king has a secret, otherworldly portal in his castle. They also say he thinks you aim to replace him.",
			effectDesc:
		...
		landReform: {
			...
			researchedMessage:
				"Delegated the task of chopping up land to a central agency. Farms have been moved and things are back on track.",
			effectDesc:
				"Farms cost a fifth of the sand. We really have a bad habit of being disorganized, don't we?",
			cost: {
				science: 5e15,
				sponge: 5e18,
			},
		...
		finalDraft: {
			...
			effectDesc:
				"You expressed that you didn't mean to replace him. He agreed to follow you to the city to see that for himself.",
			cost: {
				science: 2e16,
			},
			required: {
		...
		apologeticAmnesty: {
			...
			researchedMessage:
				"The king has decided to open the gate for us, on the condition that he takes control of the frenzy. A deal's a deal.",
			effectDesc:
	...
	tempestuous: {
		...
		cavernousContact: {
			...
			researchedMessage:
				"Found weird long-nose fish. Long, pointy noses... It was an awkward first encounter.",
		...
		crystalSpear: {
			...
			researchedMessage:
				"We've designed various pointy implements for billfish to use. A sharper slash is a better slash.",
			effectDesc:
				"Billfish catch fish two and a half times faster thanks to a diversified toolset.",
			cost: {
				science: 125,
				fish: 1000,
				crystal: 25,
		...
		seabedGeology: {
			...
			effectDesc:
				"Rays are twice as effective with their understanding of the seabed and its varieties of sediment. Also got seagrass. Yay?",
			cost: {
				science: 250,
				sand: 750,
			},
		...
		sandbagging: {
			...
			researchedMessage:
				"The billfish showed us how to tie seagrass into bundles. By filling them with sand, we can weigh down crabs!",
			effectDesc:
				"We can equip crabs with sandbags to make them into stormgoers. They can venture much farther from the cave.",
			cost: {
				science: 500,
				sand: 5000,
				seagrass: 10,
		...
		xenobiology: {
			...
			researchedMessage:
				"Flowers! What does that even mean!? Further research required. It could be such a benefit for science!",
			effectDesc:
				"We can now dissect seagrass flowers to further the cause of science.",
			cost: {
				science: 1250,
				seagrass: 500,
			},
		...
		magicBottles: {
			...
			researchedMessage:
				"With enough study, we were finally able to reproduce them. Now the question is, what to do with them?",
			effectDesc:
				"We can now make magic bottles that spew endless wind. Further study is DEFINITELY required.",
			cost: {
				science: 250000,
				crystal: 20000,
			},
		...
		senseOfDirection: {
			...
			researchedMessage:
				"Our scientists have devised a method of charting that should help us stay oriented. No more getting lost! Maybe!",
			effectDesc:
		...
		laserLenses: {
			...
			researchedMessage:
				"It turns out that a more focused beam is also a hotter beam. And hotter probably equals better.",
			effectDesc:
		...
		crystalClippers: {
			...
			effectDesc:
				"Stormgoers are three times as effective at picking up seagrass thanks to actual tools.",
			cost: {
				science: 1000000,
				crystal: 50000,
			},
		...
		exploration: {
			...
			desc: "Swim beyond the home seas to see what can be found!",
			researchedMessage:
				"Found lots of vents, grass, and more empty space! There's really not much out here.",
			effectDesc:
				"Explorers are four times as effective and scientists are twice as effective. Did you know oceans are big? Fascinating!",
			cost: {
				science: 5000000,
				fish: 2000000,
			},
		...
		heatHarnesses: {
			...
			researchedMessage:
				"Crystal vests! Remarkable! If we can't go to the heat, we'll just bring the heat to us!",
			effectDesc:
		...
		superclippers: {
			...
			effectDesc:
				"Stormgoers clip eight times as much seagrass. You should have seen the look on their faces.",
			cost: {
				science: 75000000,
				crystal: 1000000,
			},
		...
		farExploration: {
			...
			effectDesc:
				"Explorers are eight times as effective. Did you know oceans are actually even bigger than big? Remarkable!",
			cost: {
				science: 125000000,
				fish: 2500000,
			},
		...
		universalNavigation: {
			...
			researchedMessage:
				"This is getting complicated, though we doubt the billfish will struggle with these new instructions.",
			effectDesc:
				"Explorers are eight times as effective. One way or another, we will uncover the secrets of this world.",
			cost: {
				chart: 50000,
			},
			required: {
		...
		cartographicCompleteness: {
			...
			researchedMessage:
				"We've done it! The grand map is assembled, and...what's that? You found something?",
			effectDesc:
		...
		supernaturalSeagrass: {
			...
			researchedMessage:
				"Indeed, something's strange; this seagrass is immune to undersea currents! MUCH more study is required.",
			effectDesc:
				"Studying seagrass now gives 10 times the science that it used to. MAGIC SUPER SCIENCE, GO!",
			cost: {
				seagrass: 50000000,
			},
			required: {
		...
		secretStudies: {
			...
			effectDesc:
				"Learned to read these so-called 'documents.' What are the scientists so riled up about? Are they magic or something?",
			cost: {
				science: 3.5e8,
			},
			required: {
		...
		transmutation: {
			...
			researchedMessage:
				"Huzzah! We've replicated this strange material, and named after the first synthesizer, Dr. Sharkonium!",
			effectDesc:
				"Enables transmutation of some random junk we have lying around into sharkonium, material of the future.",
			cost: {
				science: 4e8,
		...
		sharkoniumReceptors: {
			...
			effectDesc:
				"Laser rays are twice as efficient. It's that whole 'hotter equals better' thing again.",
			cost: {
				science: 7.5e8,
				sharkonium: 1e6,
			},
		...
		engineering: {
			...
			researchedMessage:
				"After some intense studying, the billfish have volunteered to help us run the machines!",
			effectDesc:
				"Billfish mechanics can now tinker with machines to keep them running optimally! Auto-transmuters are also possible now.",
			cost: {
				science: 1e9,
				sharkonium: 5e6,
			},
		...
		internalExploration: {
			...
			effectDesc:
				"Mechanics are five times as effective at tinkering. We now also know that the facility has no power.",
			cost: {
				science: 2e9,
			},
			required: {
		...
		iterativeDesign: {
			...
			effectDesc:
				"All shark machines run four times as fast, but now laser rays now run 4 times faster too. Yay!",
			cost: {
				science: 8e9,
				sharkonium: 4e8,
			},
		...
		supernaturalHarvest: {
			...
			researchedMessage:
				"Indeed, there is! But we have no idea how to use it. So we'll just wrap stuff in it and hope for the best.",
			effectDesc:
				"New, magic sandbags make stormgoers 99 times better at harvesting stuff. We genuinely have no idea! It just works.",
			cost: {
				seagrass: 4e9,
			},
			required: {
