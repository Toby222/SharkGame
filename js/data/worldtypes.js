SharkGame.WorldTypes = {
	...
	tempestuous: {
		...
		foresight: {
			vagueLongDesc:
				"It's hard to feel out this place. Everything's constantly moving.",
			longDesc:
	...
	volcanic: {
		...
		modifiers: [
			{
				type: "multiplier",
				modifier: "planetaryFishMultiplier",
				resource: "ray",
				amount: 15,
			},
		],
			...
			get tip() {
				return (
					...
					(gateway.isWorldBeaten("abandoned")
						...
						: "an unrecognizable substance" +
							". It is only harmful when machines produce it.")
				);
			},
		},
		entry:
