	...
	messages: {
		...
		marine: [
			{
				name: "marine-default",
				message:
					"Schools of fish fill the vast expanse. This place feels so familiar.",
			},
			{
				name: "marine-noticed-lobsters",
				unlock: { upgrade: ["crystalContainer"] },
				message:
					"You notice some creatures on the ocean floor. They laze about and ignore your presence.",
			},
			{
			...
			},
			{
				...
				message:
					"The lobsters work, but seem carefree. They worry about nothing.",
			},
			{
			...
			},
			{
				...
				message:
					"Calcinium. It's rough, hard, and chalky. It feels fragile, but isn't.",
			},
			{
				name: "marine-robotics",
				unlock: { totalResource: { clamScavenger: 1 } },
				message:
					"A cold, rough limb fishes clams out of the seabed. The lobsters watch intently.",
			},
			{
			...
			},
			{
				...
				message:
					"All of us have boards now. Children are born half-machine. The lobsters call it effective.",
			...
			},
			{
				...
				message:
					"Murk spills out of the frenzy. A rancid fog begins to descend. This dying world drags everyone down with it.",
			},
		],
		...
		haven: [
			{
				name: "haven-default",
				message:
					"These oceans are rich with life. A thriving reef surrounds you.",
			},
			{
			...
			},
			{
				...
				message:
					"Pieces of condensed kelp (???) are washing up in the currents.<br/>Something is carved into them.",
			},
			{
				name: "haven-stories",
			...
			},
			{
				...
				message:
					"The whales speak rarely to us, working in silence as they sing to the ocean. What do they sing for?",
			},
			{
				name: "haven-history",
			...
			},
			{
				...
				message:
					"The great song booms across the open water, carrying itself to all corners of the ocean.<br/>The gate reacts.",
			},
		],
		...
		tempestuous: [
			{
				...
				message:
					"Horrible wind whips you around, scattering your possessions and allies.",
			},
			{
				name: "tempestuous-cave",
				unlock: { upgrade: ["statsDiscovery"] },
				message:
					"You take shelter inside the cave. You can still feel the wind, but it's gentle now.",
			},
			{
			...
			},
			{
				...
				message:
					"The so-called 'billfish' apologize for their behavior. They say no shark has entered this cave in a long, long time.",
			},
			{
            ...
            }, */
			{
				...
				message:
					"A silent wind swirls gently in each bottle. You feel the tumbling of a storm inside.",
			},
			{
			...
			},
			{
				...
				message:
					"A grand map lays stretched out against the cavern wall. In the top right corner is a strange shape with a door.",
			},
			{
				name: "tempestuous-machine",
				unlock: { upgrade: ["theExpedition"] },
				message:
					"The hallways of the facility echo with sounds of turning cogs. Billfish swim rapidly up and down the halls.",
			},
			{
			...
			},
			{
				...
				message:
					"As the storm draws its final breath, you overhear two billfish talking. One asks the other why the visitor never returned.",
			},
		],
		...
		volcanic: [
			{
				...
				message:
					"Scorching vents fill the sea with white and black smoke. There's not a shark in sight.",
			},
			{
				name: "volcanic-shrimp-contact",
				unlock: { totalResource: { sponge: 1 } },
				message:
					"You are approached by a single shrimp. They relay a message to you: stop harvesting sponges, or face the wrath of the king of shrimps.",
			},
			{
				...
				message:
					"You are approached by an army of shrimp. They relay a very clear message to you: cooperate, or be destroyed. You decide to stop harvesting sponges.",
			},
			{
				name: "volcanic-shrimp-communication",
				unlock: { upgrade: ["consistentCommunication"] },
				message:
					"The sponge homes left behind by shrimp joining the frenzy may now be taken for ourselves.",
			},
			{
				name: "volcanic-monarchy",
				unlock: { totalResource: { queen: 1 } },
				message:
					"The shrimps follow a caste system with the king of shrimps on top. They ask who your king is.",
			},
			{
			...
			},
			{
				...
				message:
					"Porite: glassy hunks sealed on the outside but porous on the inside: it's lightweight, yet it stays strong.",
			},
			{
				name: "volcanic-noticed",
				unlock: { upgrade: ["glassTempering"] },
				message:
					"Rumors say the king has caught wind of your plans. They say he plans to destroy the entire frenzy.",
			},
			{
				name: "volcanic-acolytes",
				unlock: { upgrade: ["algaeAcolytes"] },
				message:
					"The acolytes gather. They pray for their king. They pray for their world. They pray for you.",
			},
			// Rumor has it that the king of shrimps guards the key to a secret, sacred gate in his sandcastle.
			{
				...
				message:
					"The king is speechless. As he views the great industrial city, his subjects gather and cheer, celebrating his arrival.",
			},
			{
				name: "volcanic-hope",
				unlock: { upgrade: ["apologeticAmnesty"] },
				message:
					'"Perhaps not all sharks are so vile," says the king of shrimps. "Perhaps, you will be different."',
			},
		],
		...
		abandoned: [
			...
			},
			{
				...
				unlock: { upgrade: ["statsDiscovery"] },
				message:
					"An octopus wanders over. It scrutinizes your attempt at organization.",
			},
			{
			...
			},
			{
				...
				message:
					"Residue pumps through spronge like blood. It pulses and throbs.",
			},
			{
				name: "abandoned-exploration",
				unlock: { upgrade: ["exploration"] },
				message:
					"Great spires loom in the distance. Loose cables are strung together on the horizon.",
			},
			{
				name: "abandoned-gate",
			...
			},
			{
				...
				message:
					"The light is blinding, but the output is worth it. The pieces of a broken past unite to create a brighter future.",
			},
			{
				name: "abandoned-done",
				unlock: { upgrade: ["artifactAssembly"] },
				message:
					"The gate buzzes to life, glowing ethereally. If you squint, you can barely make out a blue ocean on the other side.",
			},
			{
			...
			},
			{
				...
				message:
					"Only machines will remain. All is lost. <span class='smallDesc'>All is lost.</span>",
				transient: true,
			},
		],
		...
		shrouded: [
			{
				...
				message:
					"The crystals are easier to find, but the darkness makes it hard to find anything else.",
			},
			{
				name: "shrouded-eel-onlookers",
				unlock: { upgrade: ["crystalContainer"] },
				message:
					"Divers have reported sightings of wiggly things on the ocean floor. They dart into their holes when approached.",
			},
			{
				name: "shrouded-eels",
				unlock: { totalResource: { eel: 1 } },
				message:
					"The eels chatter among their hiding places. They like the sharks.",
			},
			{
				name: "shrouded-distant-chimaeras",
				unlock: { upgrade: ["exploration"] },
				message:
					"In the fog of darkness, the shapes of strange creatures can be made out. They dart away when light approaches.",
			},
			{
			...
			},
			{
				...
				message:
					"These hadal artifacts glow faintly, only in pitch blackness. That glow makes you feel something that you don't understand.",
			},
			{
				name: "shrouded-power",
			...
			},
			{
				...
				message:
					"The sounds of explorers echo endlessly through the tunnels of the broken city. The eels say they are filled with hope.",
			},
			{
				name: "shrouded-truth",
				unlock: { totalResource: { sacrifice: 9000000000000000 } },
				message:
					"A team of eels get your attention. They have something from the caverns: it's a book, filled with images of pink crystals.",
			},
		],
		...
		frigid: [
			...
			},
			{
				...
				message:
					"So cold. So hungry. <span class='smallDesc'>So hopeless.</span>",
			},
			{
			...
			},
			{
				...
				message:
					"The squid champion the value of teamwork and the necessity of cooperation. They say they follow by example.",
			},
			{
				name: "frigid-machine",
			...
			},
			{
				...
				message:
					"The squid speak of an ancient visitor who saved their world. They ask if you too, have seen this visitor.",
			},
			{
				name: "frigid-suspicion",
				unlock: { upgrade: ["automation"] },
				message:
					"The squid describe the machine with fascination. They ask if we feel the same. They see something we do not.",
			},
			{
				name: "frigid-battery",
			...
			},
			{
				...
				message:
					"A wave of heat washes over you, and the dingy complex comes back to life. The gate turns on.",
			},
		],
		/*
        {
