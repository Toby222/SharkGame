SharkGame.FunFacts = {
    ...
    resourceBased: {
        ...
        crab: [
            "Throughout history, many species of crustaceans have independently evolved into crabs for no discernable reason. The phenomenon is called carcinisation.",
        ...
        octopus: [
            ...
            "Octopuses are capable of extremely advanced camouflage. They can change color, pattern, and texture to match their surroundings, enough to easily fool anything, even humans.",
        ...
        sponge: [
            ...
            "Many species of sponge have a mutualistic relationship with species of algae. The algae use photosynthesis to produce food for the sponges.",
        ],
        algae: [
    ...
    default: [
        ...
        "Any time walls in this game can be completely bypassed with good strategy.",
