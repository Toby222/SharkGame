    ...
    checkTabUnlocks() {
        $.each(SharkGame.Tabs, (tabName, tab) => {
            ...
            if (reqsMet) {
                ...
                switch (tabName) {
                    case "reflection":
                        if (!SharkGame.persistentFlags.seenReflection) log.addDiscovery("Descobriu " + tab.name + "!");
                        break;
                    case "cheats":
                        if (!SharkGame.persistentFlags.seenCheatsTab) log.addDiscovery("Descobriu " + tab.name + "!");
                        break;
                    default:
                        log.addDiscovery("Descobriu " + tab.name + "!");
                }
