...
SharkGame.HomeActions = {
    ...
    volcanic: {
        ...
        getResearcher: {
            ...
            multiOutcomes: [
                // All of these are Dexter Laboratory quotes
                "Omelette du fromage!",
                "Um professor de física e seu assistente trabalham liberando íons de hidróxilo negativamente carregados, e então o assistente disse 'Espere professor! Porque os ácidos salícilos não aceitam os íons de hidróxilo? E o professor responde 'Esses não são íons de hidróxilo! Essa é minha mulher!",
                "Hoje é um bom dia para a ciência!",
                "SAIA DO MEU LABORATÓRIO!",
                "Você está me achando com cara de q, de cadeira é?.",
                "Você não é um estivador, meu amigão, você não é um número, você é um gênio!",
                "Viu, eu não falei que suas ideias eram geniais?",
                "Eu não pensei que podia acontecer, mas estou mais gênio do que eu já era.",
                "Olá, olá, olá, hm, olá, ei, quê?, olá, oi, olá, quer parar?, quem?, oque?, olá, oi, quer parar?, quê?, oi, oi, oi, para, oquê? olá, olá, hum? olá, oi, oi, oquê? oi, PARA.",
    ...
    tempestuous: {
        ...
        getBillfishPair: {
            ...
            outcomes: [
                ...
                "Dois de um faz um de... dois? Tá correto isso mesmo?",
                "Eu vos declaro peixe e espada.",
                "Achei duas almas gêmeas!",
                "Juntamos dois peixes machos... Ainda funciona, não?",
                "Juntamos dois peixes fêmeas... Ainda deve servir, certo?",
                "Nesse caso, o todo realmente é mais que a soma das partes.",
            ],
            multiOutcomes: [
                "Pareamos algums peixes-espada.",
                "Os animaizinhos, subindo de dois em dois.",
                "Achar casais compatíveis é muito mais difícil do que parece.",
            ],
            helpText: "Dê uma de cupido e junte um par de peixes-espada para continuar o ciclo da vida.",
        },

        getBillfishExplorer: {
            name: "Equipe uma espada exploradora",
            effect: {
                resource: {
                    billfishExplorer: 1,
                },
            ...
            outcomes: [
                "Fique com deus lá fora.",
                "O peixe-espada sai avoado, com um olhar determinado.",
                "Esse explorador se atira tempestade adentro.",
                "O explorador toma alguns mapas em branco e então sai para explorar o oceano.",
                "O espadim revê o plano mais uma vez antes de se jogar nas correntes marinhas.",
            ],
            multiOutcomes: [
                "Quem não arrisca não petisca.",
                "Um cardume sai correndo para as águas agitadas.",
                "Eles parecem nem estar com medo.",
                "O time pega um monte de mapas em branco antes de saírem da caverna.",
                "Vendo tantos assim em um grupo...talvez nosso sistema de propulsão é complicado demais.",
                "O processo de preparar todo esse equipamento é um pesadelo.",
                "Um grupo bravamente sai da caverna ao oceano exterior.",
            ],
            helpText: "Arrume um sistema de propulsão complexo amarrado num peixe-espada e treine ele para cartografar o oceano.",
            removedBy: {
        ...
        getBillfishMechanic: {
            ...
            outcomes: [
                "Esta espada leu o manual de instruções e agora está pronto para quebr- QUERO DIZER, melhorar coisas.",
                "Aperta este daqui, e aquele ali, e esse daí, e...parabéns, você quebrou.",
                "Folga esse parafuso aqui, e esse bem do lado, e...eu não percebi diferença alguma.",
                "Este novo mecânico faz uma manutenção rotineira em uma armadilha de peixe.",
                "Este novo mecânico faz uma manutenção rotineira em um comedor de areia.",
                "Mecânico pronto para mecâ...nizar? Deve ser algo assim.",
                "Um mecânico se aproxima de uma máquina, percebe que esqueceu das suas ferramentas, e tenta disfarçar dando um volta por aí.",
                "Um mecânico novo, direto do arquivo de patentes.",
            ],
            multiOutcomes: [
                "Mecânicos adquiridos.",
                "Mecânicos fazem nosso trabalho ficar todo sapatinho. Isso é ótimo e tals, mas o que é um sapato?",
                "Eles sabem tantas palavras grandes. Isso é necessário mesmo?",
                "Os mecânicos se amontoam num comedor de areia, e imediatamente o quebram, só para depois remontá-lo melhor do que era antes.",
                "As ferramentas de cristal desses manos são tão caras! Mas gastar mais tubarônio seria pior, então só temos que aguentar.",
                "Eles se preparam para remendar.",
                "As espadas analisam as máquinas de todo jeito possível.",
                "Eu me pergunto o que eles estão fazendo. Porque, honestamente, eu não tô conseguindo entender nada.",
                "Eles parecem não ter ideia do que estão fazendo, mas eu não posso negar os resultados deles.",
            ],
            helpText: "Treine um peixe-espada para mexer nas nossas máquina, e os dê os recursos para consertá-las.",
        },
