...
SharkGame.Gateway.Messages = {
    ...
    lastPlanetBased: {
        ...
        haven: [
            ...
            "Por que saíste?",
            "A falação dos golfinhos finalmente deu um basta.",
            "Algo ecoou do portal para dentro desse mundo. Foste tu?",
            "Perguntaste-te como os golfinhos chegaram nessa situação?",
        ],
        tempestuous: [
        ...
        volcanic: [
            "O oceano fervente parece que apenas te incentivou.",
            "És forjado pelas fontes termais.",
            "Os camarões não são tão simples quanto imaginávemos. Demonstraste isso perfeitamente.",
            "Aquele ambiente é ideal para a vida. Mesmo que não teu tipo.",
            "Já te perguntase por que não achamos tubarões naquele mundo?",
            "O rei ficou tão assustado quando te viu. Já questionaste o porquê?",
        ],
        abandoned: [
            "Perguntaste quem abandonou as máquinas?",
