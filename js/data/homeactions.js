SharkGame.HomeActions = {
	...
	getActionTable(worldType = world.worldType) {
		if (
			typeof SharkGame.HomeActions[worldType] !== "object" ||
			worldType === "generated"
		) {
			worldType = "default";
		}
		...
		if (!_.has(SharkGame.HomeActions.generated, worldType)) {
			SharkGame.HomeActions.generated[worldType] =
				SharkGame.HomeActions.generateActionTable(worldType);
		}
	...
	generateActionTable(worldType = world.worldType) {
		const defaultActions = SharkGame.MiscUtil.cloneDeep(
			SharkGame.HomeActions.default,
		);
		...
		const finalTable = {};
		const worldActions = SharkGame.MiscUtil.cloneDeep(
			SharkGame.HomeActions[worldType],
		);
	...
	default: {
		...
		catchFish: {
			...
			effect: {
				resource: {
					get fish() {
						return SharkGame.Aspects.apotheosis.level > 0
							? SharkGame.Aspects.apotheosis.level * 4
							: 1;
					},
				},
			},
		...
		getJellyfish: {
			...
			helpText:
				"Take a great risk in catching a jellyfish without being stung.",
		},
		...
		seaApplesToScience: {
			...
			helpText:
				"Dissect the sea apples our kelp attracts to gain additional science. Research!",
		},
        ...
        */
		...
		transmuteSharkonium: {
			...
			helpText:
				"Convert ordinary resources into sharkonium, building material of the future!",
		},
		...
		smeltCoralglass: {
			...
			helpText:
				"Smelt resources into coralglass for use in crustacean machines!",
		},
		...
		getManta: {
			...
			helpText:
				"Hire a ray to help collect fish. They might kick up some sand from the seabed.",
		},
		...
		getScientist: {
			...
			helpText:
				"Train a shark in the fine art of research and the science of, well, science.",
		},
        ...
        */
		...
		getNurse: {
			...
			helpText:
				"Remove a shark from fish duty and set them to shark making duty.",
		},
		...
		getLaser: {
			...
			helpText:
				"Remove a ray from sand detail and let them fuse sand into raw crystal.",
		},
        ...
        */
		...
		getMaker: {
			...
			helpText:
				"Remove a ray from sand business and let them concentrate on making more rays.",
		},
        ...
        */
		...
		getPlanter: {
			...
			helpText:
				"Equip a crab with the equipment and training to plant kelp across the ocean bottom.",
		},
        ...
        */
		...
		getBrood: {
			...
			helpText:
				"Meld several crabs into a terrifying, incomprehensible crab-producing brood cluster.",
		},
        ...
        */
		...
		getCrystalMiner: {
			...
			helpText:
				"Construct a machine to automatically harvest crystals efficiently.",
		},
	...
	abandoned: {
		...
		forgeSpronge: {
			...
			helpText:
				"Repurpose boring old sponge into spronge, building material of the future.",
		},
		...
		getCollector: {
			...
			helpText:
				"Instruct a crab on the proper way to collect sponges from rocks.",
		},
		...
		getInvestigator: {
			...
			helpText:
				"Delegate an octopus to investigate strange objects and phenomena for science.",
		},
		...
		getScavenger: {
			...
			helpText:
				"Delegate an octopus to scavenge strange mechanical components from the city.",
		},
		...
		getClamCollector: {
			...
			helpText:
				"This octopus machine collects clams. Simple purpose, simple machine.",
		},
		...
		getSprongeSmelter: {
			...
			helpText:
				"This octopus machine imbues sponge with industrial potential. Requires residue for function.",
		},
	},
	haven: {
		catchFish: {},
		...
		fuseDelphinium: {
			...
			helpText:
				"Fuse valuable resources into delphinium, which is kinda like sharkonium. Except worse.",
		},
		...
		getDolphin: {
			...
			helpText:
				"Pay a dolphin to help us get coral or something. Prepare to put up with whining.",
		},
		...
		getWhale: {
			...
			cost: [
				{ resource: "fish", costFunction: "linear", priceIncrease: 25000 },
			],
			max: "whale",
			prereq: {
			...
			helpText:
				"Persuade one of the great whales to help us out. They can round up entire schools.",
		},
		...
		getChorus: {
			...
			helpText:
				"Form the singers of the eternal song. Let it flow through this world.",
		},
		...
		getCrimsonCombine: {
			...
			helpText:
				"This dolphin machine pries coral from the reefs at a reckless pace.",
		},
	...
	frigid: {
		...
		getSquid: {
			...
			helpText:
				"Enlist a squid to help us hunt down fish. Squid are used to the cold.",
		},
		...
		getUrchin: {
			...
			helpText:
				"Attract an urchin who will gather kelp and sand. Urchins are used to the cold.",
		},
		...
		getExtractionTeam: {
			...
			helpText:
				"Convince a squid and a crab to work together to gather crystals.",
		},
	...
	shrouded: {
		...
		makeSacrifice: {
			...
			cost: [
				{ resource: "arcana", costFunction: "constant", priceIncrease: 1 },
			],
			max: "arcana",
			prereq: {
		...
		getEel: {
			...
			helpText:
				"Offer a new home and fish supply to an eel. They can round up fish and sand.",
		},
		...
		getDiver: {
			...
			helpText:
				"Let a shark go deep into the darkness for more crystals and whatever else they may find.",
		},
		...
		getSifter: {
			...
			helpText:
				"Specialise an eel in finding interesting things on the seabed.",
		},
	...
	marine: {
		...
		pearlConversion: {
			...
			effect: {
				resource: {
					get crystal() {
						if (SharkGame.Upgrades.purchased.includes("highEnergyFusion"))
							return 5;
						return 1;
					},
				},
		...
		fuseCalcinium: {
			...
			helpText:
				"Smelt resources into calcinium for use in crustacean machines.",
		},
		...
		getClamScavenger: {
			...
			helpText:
				"Strap a big goofy claw arm to a ray and train it to scoop huge amounts of clams.",
		},
		...
		getSeabedStripper: {
			...
			helpText:
				"Equip a planter with many additional arms for maximum efficiency.",
		},
		...
		getBerrier: {
			...
			helpText:
				"Dedicate a lobster to egg production. We don't know how it works. Ask the lobsters.",
		},
		...
		getCalciniumConverter: {
			...
			helpText:
				"Modify a lobster to fuse calcinium with cool cyborg laser beams.", // This crustacean machine distributes lobster eggs for optimal hatching conditions.
		},
	},
	volcanic: {
		// FREEBIES ////////////////////////////////////////////////////////////////////////////////
		...
		toggleAutoSmelt: {
			...
			getSpecialTooltip() {
				...
				if (SharkGame.flags.autoSmelt) {
					...
					const sandCost =
						SharkGame.HomeActions.volcanic.smeltPorite.cost[1].priceIncrease;
		...
		getShoveler: {
			...
			cost: [
				{ resource: "ray", costFunction: "constant", priceIncrease: 1 },
				{
					...
					costFunction: "linear",
					get priceIncrease() {
						return SharkGame.Upgrades.purchased.includes("massProduction")
							? 10
							: 50;
					},
				},
			...
			helpText:
				"Teach a ray to quickly move sand around using a huge, specialized scoop.",
		},
		...
		getCuriousCrab: {
			...
			helpText:
				"Find a crab that is curious and recognize them as a curious crab.",
		},
		...
		getResearcher: {
			...
			outcomes: [
				...
				"These papers won't write themselves!",
			],
			multiOutcomes: [
			...
			helpText:
				"Grant a curious crab enough equipment to perform actual experiments.",
		},
			...
			cost: [
				{
					...
					costFunction: "constant",
					get priceIncrease() {
						return SharkGame.Upgrades.purchased.includes("broodingBiology")
							? 5
							: 20;
					},
				},
		...
		getAcolyte: {
			...
			helpText:
				"Indoctrinate a shrimp into the cult of algae to boost algae production.",
		},
		...
		getSpongeFarm: {
			...
			cost: [
				{ resource: "sponge", costFunction: "constant", priceIncrease: 1 },
				{
					...
					costFunction: "linear",
					get priceIncrease() {
						return SharkGame.Upgrades.purchased.includes("landReform")
							? 50
							: 250;
					},
				},
	...
	tempestuous: {
		...
		seagrassToScience: {
			...
			effect: {
				resource: {
					get science() {
						return SharkGame.Upgrades.purchased.includes("supernaturalSeagrass")
							? 10
							: 1;
					},
				},
			...
			cost: [
				{ resource: "seagrass", costFunction: "constant", priceIncrease: 2 },
			],
			max: "seagrass",
			prereq: {
				resource: {
			...
			helpText:
				"Dissect seagrass flowers to further the cause of science. This is research, probably!",
		},
		...
		getBillfish: {
			...
			helpText:
				"Fetch a billfish from the back of the cave and ask them to help us catch fish.",
		},
		...
		getLaser: {
			cost: [
				{ resource: "ray", costFunction: "constant", priceIncrease: 1 },
				{
					...
					costFunction: "linear",
					get priceIncrease() {
						return SharkGame.Upgrades.purchased.includes("laserLenses")
							? 10
							: 50;
					},
				},
		...
		getStormgoer: {
			...
			cost: [
				...
				{ resource: "seagrass", costFunction: "constant", priceIncrease: 10 },
				{
					...
					costFunction: "linear",
					get priceIncrease() {
						return SharkGame.Upgrades.purchased.includes("heavySifting")
							? 25
							: 100;
					},
				},
			...
			helpText:
				"Weigh down a crab with sand to keep it from being carried away in the storm.",
		},
		...
		getBillfishPair: {
			...
			helpText:
				"Do a bit of matchmaking and pair up two billfish to continue the circle of life.",
		},
		...
		getBillfishExplorer: {
			...
			helpText:
				"Rig a complex propulsion system to a billfish and train them to chart surrounding waters.",
			removedBy: {
		...
		getBillfishMechanic: {
			...
			helpText:
				"Train a billfish to operate our machines, and give it the resources needed to tinker with them.",
		},
