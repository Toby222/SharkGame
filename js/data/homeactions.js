...
SharkGame.HomeActions = {
    ...
    default: {
        ...
        debugbutton: {
            ...
            outcomes: [
                "Testando, testando. Conseguem me ouvir?",
                "Bugs detectados.",
        ...
        prySponge: {
            ...
            outcomes: [
                "Tirou uma esponja não identificada das pedras.",
                "Tirou uma esponja Salvador Dali das pedras.",
                "Tirou uma esponja encrustante tão suja que nem conseguimos ver a cor dela das pedras.",
                ...
                "Tirou uma esponja vermelha calci das pedras.",
                ...
                "Tirou uma esponja 'Puffball' larabja das pedras.",
                "Tirou uma esponja verdinha em forma de bolinha do solo.",
                "Pried a loggerhead sponge from the rocks.",
                "Tirou uma esponja amarelinha das pedras.",
                "Tirou uma esponja encrustante laranja das pedras.",
